...
export default async function PaymentPage(props: {
  ...
  if (!userId) {
    // redirect(getI18nPath('/sign-in', params.locale));
  }
  ...
  // Get user info for display (optional - can be removed if not needed)
  // Note: We can't easily get user details in server component without additional API call
  // For now, we'll use a generic welcome message
